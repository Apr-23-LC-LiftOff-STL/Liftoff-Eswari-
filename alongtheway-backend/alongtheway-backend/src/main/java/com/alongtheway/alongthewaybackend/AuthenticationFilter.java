...
import com.alongtheway.alongthewaybackend.controllers.AuthenticationController;
...
public class AuthenticationFilter extends HandlerInterceptorAdapter {
    ...
    private static final List<String> whitelist = Arrays.asList("/login", "/signup", "/aboutusandfaq", "/");
